...
class SandwichPluginManager extends DefaultPluginManager
{
     ...
     *   The module handler to invoke the alter hook with.N
     */
    public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler)
    {
        ...
        // live. Example: Drupal\{module_name}\Plugin\Sandwich\MySandwichPlugin;
        ...
        $plugin_interface = 'Drupal\sandwich\SandwichInterface';

        // The name of the annotation class that contains the plugin definition.
        $plugin_definition_annotation_name = 'Drupal\sandwich\Annotation\Sandwich';
